...
function render() {
  ...
  if (!state.basicInfo || !state.basicInfo.title) {
    renderIntro();
    return;
  }
  ...
  app.innerHTML = `
    <main class="intro-page">
      <section class="intro-hero">
        ...
        <h1>关于“AI辅助科学基金申请”系统的专家评估邀请</h1>
        <div class="intro-copy">
          <p>尊敬的老师：您好！我们正在进行一项关于大模型多智能体系统辅助科学基金申请的研究，旨在探索人工智能是否能够基于前沿科学话题，自主生成具有高度创新性的前沿科学研究方案。我们诚挚邀请您担任本次实验的评估专家！</p>
          <p>我们选取了国家自然科学基金（NSFC）指南中的前沿科学问题作为输入，利用不同的AI系统架构（包括单体大模型和多智能体系统）生成了若干份研究方案。</p>
          <p>您将收到 4 组针对不同选题的研究方案。每组包含 3 份由不同系统生成的匿名方案，PDF 文件中的“系统输入”为科学话题，“系统输出”为根据该话题生成的方案。我们希望通过您的专业视角，客观评估这些方案的科学价值。</p>
        </div>
      </section>
...
function downloadCsv() {
  const rows = [
    [
      "参与者ID", "开始时间", "提交时间", "职称", "研究方向", "取得博士学位至今时间（年）",
